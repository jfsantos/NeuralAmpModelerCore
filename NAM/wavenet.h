...
class _Layer {
 public:
  ...
  // :param `i_start`: Index of the first column of the input samples that the
...
class WaveNet : public DSP {
 ...
 protected:
  ...
  // Just one--the audio.
  virtual int _get_condition_dim() const {
    return 1;
  };
